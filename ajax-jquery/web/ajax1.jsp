...
<form action="/regist.jsp" method="post">
    用户id: <input type="text" name="productName" onblur="doCheck(this)"> <span id="msg"></span> <br>
...
//            var url = "ajaxShow.jsp";
            <%--var url = "${pageContext.request.contextPath}/CheckServlet?productName=" + obj.value;--%>
            var url = "/CheckServlet?productName=" + obj.value;
...
//                        alert(xmlHttpReg.responseXML);
                        document.getElementById("msg").innerHTML = xmlHttpReg.responseText;
